 ...
 *   }]);
     ...
     *   }
		...
		this.$get = ['$timeout', '$$asyncCallback', function($timeout, $$asyncCallback) {
			 ...
			 * insert, remove and move elements within the DOM, as well as adding and removing class.
     ...
     * page}.
			...
			return {
				 ...
				 * @function
				 * @description Adds and/or removes the given CSS class to and from the element.
				 * Once complete, the done() callback will be fired (if provided).
				 * @param {DOMElement} element the element which will it's CSS class changed
				 *   removed from it
				 * @param {string} add the CSS class which will be added to the element
				 * @param {string} remove the CSS class which will be removed from the element
				 * @param {Function=} done the callback function (if provided) that will be fired after the
				 *   CSS class have been set on the element
				 */
 ...
 * compiler}. The attributes are:
	 ...
	 * migrates all of the attributes / class from the old element to the new one. See the
						...
						success(function(content) {
							...
							while(linkQueue.length) {
								...
								if (beforeTemplateLinkNode !== beforeTemplateCompileNode) {
									...
									// Copy in CSS class from original node
								...
								pre: function attrInterpolatePreLinkFn(scope, element, attr) {
									...
									(attr.$$observers && attr.$$observers[name].$$scope || scope).
										$watch(interpolateFn, function interpolateFnWatchAction(newValue, oldValue) {
											...
											//the CSS class are the non-interpolated values
 ...
 * $httpBackend} which can be trained with responses.
   ...
   * @param {string=} value new value to set the starting symbol to.
	 ...
	 * @example
	 ...
	 <button ng-click="$log.html(message)">log</button>
...
//asks for $scope to fool the BC controller module
	...
	function FormController(element, attrs, $scope, $animate) {
		...
		// convenience method for easy toggling of class
	 ...
	 *
	 * Keep in mind that ngAnimate can detect each of these class when added and removed.
	 *
	 *
	 ...
	 * ## Animation Hooks
	 *
	 * Animations in ngForm are triggered when any of the associated CSS class are added and removed.
	 * These class are: `.ng-pristine`, `.ng-dirty`, `.ng-invalid` and `.ng-valid` as well as any
 ...
 *      }
   ...
   *     });
	 ...
	 * - Setting related css class on the element (`ng-valid`, `ng-invalid`, `ng-dirty`, `ng-pristine`) including animations.
	 ...
	 *
	 * # CSS class
	 * The following CSS class are added and removed on the associated input/select/textarea element
	 ...
	 * ## Animation Hooks
	 *
	 * Animations within models are triggered when any of the associated CSS class are added and removed
	 * on the input element which is attached to the model. These class are: `.ng-pristine`, `.ng-dirty`,
 ...
 *     });
	 ...
	 *
	 * @description
	 * The `ngClass` directive allows you to dynamically set CSS class on an HTML element by databinding
	 * an expression that represents all class to be added.
	 *
	 ...
	 *
	 * The directive won't add duplicate class if a particular class was already set.
	 *
	 * When the expression changes, the previously added class are removed and only then the
	 * new class are added.
	 *
	 * @animations
	 ...
	 *   names of the properties whose values are truthy will be added as css class to the
	 *   element.
	 *
	 * @example Example that demonstrates basic bindings via ngClass directive.
	 ...
	 it('array example should have 3 class', function() {
	 ...
	 Upon animation ngAnimate will apply supplementary CSS class to track the start and end of an animation, but this will not hinder
...
// anywhere in the current doc
	 ...
	 * position within the DOM, such as the `:first-child` or `:last-child` pseudo-class.
	 *
